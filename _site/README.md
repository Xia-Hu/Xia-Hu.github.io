...
**Site template is forked from [academic-website-template](https://github.com/sbryngelson/academic-website-template). 
Thanks to [@sbryngelson](https://github.com/sbryngelson) and other 
contributors for this amazing academic website template.**
